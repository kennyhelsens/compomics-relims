 ...
 * @author Kenneth
 */
public class IntegrityTestProject9982 extends TestCase {

    public IntegrityTestProject9982(String testName) {
        super(testName);
    }

    public static Test suite() {
        Simulator.setProjectID(9982);
        SourceFileTest.setProjectID(9982);
