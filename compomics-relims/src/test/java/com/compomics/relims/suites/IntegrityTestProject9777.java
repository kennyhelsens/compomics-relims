 ...
 * @author Kenneth
 */
public class IntegrityTestProject9777 extends TestCase {

    public IntegrityTestProject9777(String testName) {
        super(testName);
    }

    public static Test suite() {
        Simulator.setProjectID(9777);
        SourceFileTest.setProjectID(9777);
