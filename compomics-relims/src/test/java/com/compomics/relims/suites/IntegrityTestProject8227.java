 ...
 * @author Kenneth
 */
public class IntegrityTestProject8227 extends TestCase {

    public IntegrityTestProject8227(String testName) {
        super(testName);
    }

    public static Test suite() {
        Simulator.setProjectID(8227);
        SourceFileTest.setProjectID(8227);
